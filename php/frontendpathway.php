...
<section class="content">
            ...
            <div class="col-11 content__container background_color">
                ...
                <div class="content__htmlcss gradient_color">
                    <h1>Làm quen với HTML và CSS</h1>
                    ...
                    <a href="./productdetails.php?id=1" style="display: flex; justify-content: center;"><div class="pathway__img" style="background-image: url(../assets/img/htmlandcss.jpeg);"></div></a>
                </div>

                <div class="content__js gradient_color">
                    <h1>Thành thạo ngôn ngữ Javascript</h1>
                    ...
                    <a href="./productdetails.php?id=2" style="display: flex; justify-content: center;"><div class="pathway__img" style="background-image: url(../assets/img/javascript_course.jpg);"></div></a>
                </div>
                ...
                <div class="content__reactjs gradient_color">
                    ...
                    <a href="./productdetails.php?id=3" style="display: flex; justify-content: center;"><div class="pathway__img" style="background-image: url(../assets/img/react_logo.png);"></div></a>
                </div>
            </div>
</section>
