...
?>
    <div class="col-4 py-3 ">
        ...
        <form action="" method="POST">
            <input required type="text" name="danhmuc" class="input__danhmuc" value=" <?php echo $row_capnhat['category_name'] ?>">
        ...
        <table class="table">
            ...
            ?>
                <tr>
                    ...
                    <td><a href="?quanly=xoa1&xoa1=<?php echo $row_category['category_id'] ?>" class="btn btn-danger cd-popup-trigger">Xóa</a>
                        <a href="?quanly=capnhat&id=<?php echo $row_category['category_id'] ?>" class="btn btn-primary">Cập nhật</a>
                    </td>
                </tr>
            <?php
            }
